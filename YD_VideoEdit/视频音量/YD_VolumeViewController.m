...
- (void)yd_completeItemAction {
    ...
    @weakify(self);
    [YD_AssetManager yd_exporter:self.playModel.asset fileName:@"volume" composition:nil audioMix:self.playModel.audioMix finish:^(BOOL isSuccess, NSString * _Nonnull exportPath) {
        @strongify(self);
